...
def  show_the_user_selected_choice_with_pop_up():

       #Shows the choice selected by the user with a pop up

       messagebox.showinfo("information","You have selected :",choice_variable .get())
